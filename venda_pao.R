...
# criar um data frame
# qtd, custo total, venda total, custo unitario, venda unitaria
...
plot(qtd_custo_totvend_pao_diario$Quantidade)

# separar por dias (tá dando erro)
...
qtd_pao_mens_nov20 = qtd_pao_diario[364:393]
qtd_pao_mens_dez20 = qtd_pao_diario[394:424]
